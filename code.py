...
def wishme():
    ...
    speak("NARAYAN at your service. Please tell me how can I help you?")
...
def sendEmail(to, content):
    ...
    server.login('guptasidharth457@gmail.com', '9882166708a')
...
def Introduction():
    speak("I am NARAYAN 2.0 , Personal AI assistant , "
          "I am created by SHITIZ , "
...
def Creator():
    speak("SHITIZ is an extra-ordinary person ,"
          "He has a passion for Robotics, Artificial Intelligence and Machine Learning ,"
          "He is very co-operative ,"
          "If you are facing any problem regarding the 'NARAYAN 2.0', He will be glad to help you ")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        # wb.open(query)
            ...
            speak("Thanks to SHITIZ. further it is a secret")
        elif 'word' in query:
            ...
            while (
                    'number' not in rand and rand != 'random'):  # used while loop to keep the jarvis on the speak command untill req. command is given.
                speak(
